...
function bp_follow_add_follow_button( $args = '' ) {		
	...
	function bp_follow_get_add_follow_button( $args = '' ) {
		...
		if ( $is_following ) {
			...
			$action    = 'stop';
			$class     = 'unfollow';
			/* $link_text = $link_title = sprintf( __( 'Stop Following %s', 'bp-follow' ), apply_filters( 'bp_follow_leader_name', bp_get_user_firstname( $leader_fullname ), $leader_id ) ); */						$link_text = $link_title = sprintf( __( 'Fan of %s', 'bp-follow' ), apply_filters( 'bp_follow_leader_name', bp_get_user_firstname( $leader_fullname ), $leader_id ) );
		}
		else {
			$id        = 'not-following';
			$action    = 'start';
			$class     = 'follow';
			/* $link_text = $link_title = sprintf( __( 'Follow %s', 'bp-follow' ), apply_filters( 'bp_follow_leader_name', bp_get_user_firstname( $leader_fullname ), $leader_id ) ); */						$link_text = $link_title = sprintf( __( 'Become a Fan of %s', 'bp-follow' ), apply_filters( 'bp_follow_leader_name', bp_get_user_firstname( $leader_fullname ), $leader_id ) );
		}
